...
class ServicioController extends Controller
{
     ...
     *
     * @Route("/", name="pers_servicio_index")
     * @Method("GET")
     */
     ...
     *
     * @Route("/new", name="pers_servicio_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('pers_servicio_show', array('id' => $servicio->getId()));
        }
     ...
     *
     * @Route("/{id}", name="pers_servicio_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="pers_servicio_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Servicio $servicio)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('pers_servicio_edit', array('id' => $servicio->getId()));
        }
     ...
     *
     * @Route("/{id}", name="pers_servicio_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Servicio $servicio)
    {
        ...
        return $this->redirectToRoute('pers_servicio_index');
    }
    ...
    private function createDeleteForm(Servicio $servicio)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('pers_servicio_delete', array('id' => $servicio->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
